...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Mialison";
            $("#favicon").attr("href", "assets/images/cmsoon.png");
        }
        else {
            document.title = "Reviens sur mon Porfolio";
...
var typed = new Typed(".typing-text", {
    strings: ["développeur back-end", "développeur php", "développeur laravel", "développeur symfony", "web scrappeur"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
function showSkills(skills) {
    ...
    skills.forEach(skill => {
        ...
        <div class="bar">
              <div class="info">
                <img src=${skill.icon} alt="skill" width="50" height="50"/>
